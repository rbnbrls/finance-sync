...
def test_dependency_workflow_runs_all_compatibility_gates() -> None:
    workflow = Path(".github/workflows/dependency-cadence.yml").read_text(encoding="utf-8")
    for marker in ("uv lock --check", "Unit gate", "Integration gate", "E2E gate", "pip-audit", "cyclonedx"):
