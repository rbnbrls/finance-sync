...
- [x] Er is een providerinterface voor minimaal `news`, `corporate_events`,
...
- [x] Er zijn werkende adapters voor de reeds geconfigureerde OpenBB-bronnen en
...
- [x] Iedere observatie bewaart bron, canonieke URL/document-ID,
  ...
  herleidbaar.
- [x] finance-sync bewaart geen volledige auteursrechtelijk beschermde
