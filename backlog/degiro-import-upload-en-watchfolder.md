...
- [ ] Het connector-control-panel biedt voor `degiro_pension` één duidelijke
...
- [ ] Een tenant-scoped multipart upload-API accepteert uitsluitend de
...
- [ ] Uploads worden gestreamd naar een afgeschermde tijdelijke locatie,
  ...
  beheerder.
- [ ] Iedere poging krijgt een `ImportRun` met tenant, connection/account,
...
- [ ] Een preview/dry-run schrijft niets en toont mappings, onbekende
  ...
  van bestanden.
- [ ] Voor self-hosting kan per connectorconfiguratie een inkomende watchfolder
...
- [ ] De scheduler laadt zowel credentials als opgeslagen connectoropties en
...
- [ ] Een identieke bestandshash wordt niet opnieuw verwerkt tenzij een admin
...
- [ ] Unit-, API-, worker- en integratietests dekken upload, dry-run/confirm,
  ...
  tenant-isolatie.
- [ ] OpenAPI-, beheer- en deploymentdocumentatie beschrijven uploads,
