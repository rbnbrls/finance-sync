...
- [x] De Wealthfolio-exporter maakt of koppelt één herkenbaar
...
- [x] Aankopen, verkopen, stortingen, opnames, dividend, dividendbelasting,
...
- [x] Iedere security gebruikt de door finance-sync opgeloste listing en bij
...
- [x] De exporter ondersteunt een gedocumenteerde activity-first strategie voor
...
- [x] Dividendbelasting blijft afzonderlijk herkenbaar als `TAX` en wordt niet
  bij dividend opgeteld of als generieke transactiekosten verborgen.
- [x] Multi-currency activiteiten gebruiken de originele instrument-/cashvaluta
...
- [x] De finance-sync rekeningwaarde, som van holdings plus cash en de waarde in
...
- [x] Twee identieke volledige imports en twee gedeeltelijk overlappende
...
- [x] Correcties of nieuwere snapshots superseden eerdere data volgens een
...
- [x] De scheduler kan na een succesvolle DEGIRO-import alleen de betrokken
...
- [x] Een end-to-end fixturetest bewijst de route `DEGIRO exports -> parser ->
...
- [x] Een productie-smoke-run tegen de geconfigureerde self-hosted
...
- [x] Gebruikersdocumentatie beschrijft eerste import, periodiek bijwerken,
