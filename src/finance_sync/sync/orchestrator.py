    ...
    async def _run_pipeline(
        ...
        try:
            async with uow:
                ...
                raw_accounts = await connector._rate_limited_fetch_accounts()  # type: ignore[attr-defined]  # noqa: SLF001
                ...
                for ca in canonical_accounts:
                    raw_txns = await connector._rate_limited_fetch_transactions(  # type: ignore[attr-defined]  # noqa: SLF001
