...
class AISummaryService:
    ...
    def __init__(
        ...
        *,
        ...
        # The account scope restricts the underlying ReadService to the
        # principal's visible accounts, so the AI summary can never
        # describe accounts outside the scope.
